...
namespace Microsoft.OneDrive.RestProxy
{
    public abstract class ReadOnlyQueryableSetBase
    {
        ...
        protected void Initialize(Query inner,
    ...
    public abstract class ReadOnlyQueryableSetBase<TSource> : ReadOnlyQueryableSetBase, IReadOnlyQueryableSetBase<TSource>, IConcreteTypeAccessor
    {
        ...
        protected global::System.Threading.Tasks.Task<IPagedCollection<TSource>> ExecuteAsyncInternal()
        {
            if (_concreteType.Value != null)
            {
                ...
                var executeAsyncMethodInfo =
                    (from i in contextTypeInfo.GetDeclaredMethods("ExecuteAsync")
                        ...
                        where parameters.Length == 1 && parameters[0].ParameterType.GetGenericTypeDefinition() == typeof(Query<>)
                        select i).First();
            ...
            {
                return null; // Context.ExecuteAsync<TSource, TSource>((Query<TSource>)Query);
            }
        }
        ...
        protected global::System.Threading.Tasks.Task<TSource> ExecuteSingleAsyncInternal()
        {
            ...
            {
                return null; // Context.ExecuteSingleAsync<TSource, TSource>((Query<TSource>)Query);
            }
        }
        ...
        public IReadOnlyQueryableSet<TResult> Select<TResult>(System.Linq.Expressions.Expression<System.Func<TSource, TResult>> selector)
        {
            ...
            Query query = CallLinqMethod(newSelector);
        ...
        public IReadOnlyQueryableSet<TSource> Where(System.Linq.Expressions.Expression<System.Func<TSource, bool>> predicate)
        {
            ...
            Query query = CallLinqMethod(newSelector, true);
        ...
        {
            Query query = ApplyLinq(new[] { typeof(TResult) }, new object[] { Query }) ??
                                     (Query)System.Linq.Queryable.OfType<TResult>((System.Linq.IQueryable<TSource>)Query);
        ...
        {
            Query query = ApplyLinq(new[] { typeof(TSource) }, new object[] { Query, count }) ??
                                     (Query)System.Linq.Queryable.Skip<TSource>((System.Linq.IQueryable<TSource>)Query, count);
        ...
        {
            Query query = ApplyLinq(new[] { typeof(TSource) }, new object[] { Query, count }) ??
                                     (Query)System.Linq.Queryable.Take<TSource>((System.Linq.IQueryable<TSource>)Query, count);
        ...
        public IReadOnlyQueryableSet<TSource> Expand<TTarget>(System.Linq.Expressions.Expression<Func<TSource, TTarget>> navigationPropertyAccessor)
        {
            ...
            var concreteDsq = typeof(Query<>).MakeGenericType(concreteType);

            Query query = CallOnConcreteType(concreteDsq, Query, new[] { typeof(TTarget) }, new object[] { newSelector });
        ...
        private Query ApplyLinq(Type[] typeParams, object[] callParams, [System.Runtime.CompilerServices.CallerMemberName] string methodName = null)
        {
            return CallOnConcreteType(typeof(System.Linq.Queryable), null, typeParams, callParams, methodName);
        }

        private Query CallOnConcreteType(Type targetType, object instance, Type[] typeParams, object[] callParams, [System.Runtime.CompilerServices.CallerMemberName] string methodName = null)
        {
            ...
            return (Query)methodInfo.Invoke(instance, callParams);
        }
            ...
            [System.Runtime.CompilerServices.CallerMemberName] string methodName = null)
        {
            ...
            return (Query)methodInfo.Invoke(null, callParams);
        }
        #endregion
    }
}